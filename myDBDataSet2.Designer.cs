...
namespace QLSV {
    ...
    public partial class myDBDataSet2 : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public loginRow AddloginRow(string username, string password, string fname, string lname, string gmail, string phone) {
...
namespace QLSV.myDBDataSet2TableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[login] WHERE (([username] = @Original_username) AND ([password" +
                "] = @Original_password) AND ([fname] = @Original_fname) AND ([lname] = @Original" +
                "_lname) AND ([gmail] = @Original_gmail) AND ([phone] = @Original_phone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[login] ([username], [password], [fname], [lname], [gmail], [ph" +
                "one]) VALUES (@username, @password, @fname, @lname, @gmail, @phone);\r\nSELECT use" +
                "rname, password, fname, lname, gmail, phone FROM login WHERE (username = @userna" +
                "me)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[login] SET [username] = @username, [password] = @password, [fname] = @fname, [lname] = @lname, [gmail] = @gmail, [phone] = @phone WHERE (([username] = @Original_username) AND ([password] = @Original_password) AND ([fname] = @Original_fname) AND ([lname] = @Original_lname) AND ([gmail] = @Original_gmail) AND ([phone] = @Original_phone));
SELECT username, password, fname, lname, gmail, phone FROM login WHERE (username = @username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, fname, lname, gmail, phone FROM dbo.login";
        ...
        public virtual int Fill(myDBDataSet2.loginDataTable dataTable) {
        ...
        public virtual myDBDataSet2.loginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            myDBDataSet2.loginDataTable dataTable = new myDBDataSet2.loginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBDataSet2.loginDataTable dataTable) {
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_fname, string Original_lname, string Original_gmail, string Original_phone) {
            ...
            if ((Original_gmail == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_gmail));
            }
        ...
        public virtual int Insert(string username, string password, string fname, string lname, string gmail, string phone) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string fname, string lname, string gmail, string phone, string Original_username, string Original_password, string Original_fname, string Original_lname, string Original_gmail, string Original_phone) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string fname, string lname, string gmail, string phone, string Original_username, string Original_password, string Original_fname, string Original_lname, string Original_gmail, string Original_phone) {
            return this.Update(Original_username, password, fname, lname, gmail, phone, Original_username, Original_password, Original_fname, Original_lname, Original_gmail, Original_phone);
        }
    }
