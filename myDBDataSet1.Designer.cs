...
namespace QLSV.myDBDataSet1TableAdapters {
...
SELECT Id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (Id = @Id)";
        ...
        public virtual int Fill(myDBDataSet1.stdDataTable dataTable) {
        ...
        public virtual myDBDataSet1.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            myDBDataSet1.stdDataTable dataTable = new myDBDataSet1.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBDataSet1.stdDataTable dataTable) {
